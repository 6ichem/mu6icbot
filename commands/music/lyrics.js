...
module.exports = class LyricsCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      memberName: 'lyrics',
      description:
        'lyrics for any song or the currently playing song',
      group: 'music',
      throttling: {
        usages: 1,
        duration: 5
      ...
      args: [
        {
          ...
          default: '',
          type: 'string',
          prompt: 'Choose what songs you want to display the lyrics for'
        }
      ]
    });
  }
  async run(message, { songName }) {
    if (
      ...
      return message.say(
        'No song playing, try again using a song name or play a song first'
      );
    }
