...
module.exports = class PlayCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      memberName: 'play',
      group: 'music',
      description: 'play something from yt',
      guildOnly: true,
  ...
  async run(message, { query }) {
    ...
    if (!voiceChannel) return message.say('Join a voice channel and try again retard');

    if (message.guild.triviaData.isTriviaRunning == true) {
      return message.say('Try after the trivia is finished');
    }
    ...
    const embed = new MessageEmbed()
      .setColor('#e9f931')
      .setTitle('Choose a song by using a number between 1 and 5')
      ...
      .then(function(response) {
        ...
        youtube
          ...
          .catch(function() {
            ...
            return message.say(
              'Could not get the video ID from YouTube'
            );
          });
      })
      .catch(function() {
        ...
        return message.say(
          'Enter a number between 1 and 5 or gtfo idiot'
        );
      });
  }
